...
import (
	...
	"github.com/AliyunContainerService/kubernetes-cronhpa-controller/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type AutoscalingV1beta1Interface interface {
	RESTClient() rest.Interface
	CronHorizontalPodAutoscalersGetter
}

// AutoscalingV1beta1Client is used to interact with features provided by the autoscaling.alibabacloud.com group.
type AutoscalingV1beta1Client struct {
	restClient rest.Interface
}

func (c *AutoscalingV1beta1Client) CronHorizontalPodAutoscalers(namespace string) CronHorizontalPodAutoscalerInterface {
	return newCronHorizontalPodAutoscalers(c, namespace)
}
