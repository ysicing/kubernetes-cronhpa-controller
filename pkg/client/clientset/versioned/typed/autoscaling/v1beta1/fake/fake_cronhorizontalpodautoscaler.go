...
func (c *FakeCronHorizontalPodAutoscalers) UpdateStatus(ctx context.Context, cronHorizontalPodAutoscaler *v1beta1.CronHorizontalPodAutoscaler, opts v1.UpdateOptions) (*v1beta1.CronHorizontalPodAutoscaler, error) {
	obj, err := c.Fake.
